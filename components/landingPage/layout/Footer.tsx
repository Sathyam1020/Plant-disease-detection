      ...
      <Container>
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1">
              <h3 className="font-medium text-sm mb-4 text-foreground">PRODUCT</h3>
            ...
            <div className="col-span-1">
              <h3 className="font-medium text-sm mb-4 text-foreground">COMPANY</h3>
              <ul className="space-y-3">
                <li>
                  <Link href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    About Us
            ...
            <div className="col-span-1">
              <h3 className="font-medium text-sm mb-4 text-foreground">LEGAL</h3>
              <ul className="space-y-3">
                <li>
                  <Link href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    Privacy Policy
